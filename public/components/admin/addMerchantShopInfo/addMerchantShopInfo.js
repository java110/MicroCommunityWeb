(function (vc) {
    ...
    vc.extends({
        ...
        _initEvent: function () {
            vc.on('addMerchantShopInfo', 'openAddMerchantShopModal', function (_param) {
                $that.addMerchantShopInfo.storeId = _param.storeId;
                $that._initArea('101', '0');
                $that._listShopTypes();
                $('#addMerchantShopInfoModel').modal('show');
            });
        },
        methods: {
            ...
            saveMerchantShopInfo: function () {
                ...
                vc.http.apiPost(
                    ...
                    function (json, res) {
                        ...
                        if (_json.code == 0) {
                            //关闭model
                            $('#addMerchantShopInfoModel').modal('hide');
