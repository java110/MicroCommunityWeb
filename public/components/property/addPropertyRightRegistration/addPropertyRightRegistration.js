    ...
    vc.extends({
        ...
        _initEvent: function() {
            ...
            vc.on("addPropertyRightRegistration", "notifyUploadIdCardImage", function(_param) {
                vc.component.addPropertyRightRegistrationInfo.idCardPhotos = _param;
            });
            //购房合同图片上传
            vc.on("addPropertyRightRegistration", "notifyUploadHousePurchaseImage", function(_param) {
                vc.component.addPropertyRightRegistrationInfo.housePurchasePhotos = _param;
            });
            //维修基金图片上传
            vc.on("addPropertyRightRegistration", "notifyUploadRepairImage", function(_param) {
                vc.component.addPropertyRightRegistrationInfo.repairPhotos = _param;
            });
            //契税证明图片上传
            vc.on("addPropertyRightRegistration", "notifyUploadDeedTaxImage", function(_param) {
                vc.component.addPropertyRightRegistrationInfo.deedTaxPhotos = _param;
            });
        },
        methods: {
