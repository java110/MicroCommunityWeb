    ...
    vc.extends({
        ...
        _initEvent: function () {
            ...
            vc.on('reportProficientCarFee', 'switch', function (_param) {
                ...
                vc.copyObject(_param, $that.reportProficientCarFeeInfo)
                $that._listSimplifyRoomFee(DEFAULT_PAGE, DEFAULT_ROWS);

                vc.getDict('pay_fee_config', "fee_type_cd", function (_data) {
                    $that.reportProficientCarFeeInfo.feeTypeCds = _data;
                });
            });
        ...
        methods: {
            _listSimplifyRoomFee: function (_page, _row) {
                let param = {
                    params: {
                        ...
                        payerObjId: $that.reportProficientCarFeeInfo.roomId,
                        configId: $that.reportProficientCarFeeInfo.configId,
                        state: $that.reportProficientCarFeeInfo.state,
                        feeTypeCd: $that.reportProficientCarFeeInfo.feeTypeCd
                    }
                };
                ...
                vc.http.get('listRoomFee',
                    ...
                    function (json) {
                        ...
                        vc.component.reportProficientCarFeeInfo.fees = _feeConfigInfo.fees;
            ...
            _toOwnerPayFee: function () {
                vc.jumpToPage('/admin.html#/pages/property/owePayFeeOrder?payObjId=' + $that.reportProficientCarFeeInfo.roomId + "&payObjType=3333&roomName=" + $that.reportProficientCarFeeInfo.roomName);
            },
            _openRoomCreateFeeAddModal: function () {
                $that.reportProficientCarFeeInfo.ownerName = $that.reportProficientCarFeeInfo.name;
                vc.emit('roomCreateFeeAdd', 'openRoomCreateFeeAddModal', {
                    isMore: false,
                    room: $that.reportProficientCarFeeInfo,
                    ownerName: $that.reportProficientCarFeeInfo.name
                });
            },
            _openAddMeterWaterModal: function () {
                vc.emit('addMeterWater', 'openAddMeterWaterModal', {
                    roomId: $that.reportProficientCarFeeInfo.roomId,
                    roomName: $that.reportProficientCarFeeInfo.roomName,
                    ownerName: $that.reportProficientCarFeeInfo.name
            ...
            _payFee: function (_fee) {
                _fee.roomName = $that.reportProficientCarFeeInfo.roomName;
                _fee.builtUpArea = $that.reportProficientCarFeeInfo.builtUpArea;
            ...
            _changeSimplifyRoomFeeFeeTypeCd: function (_feeTypeCd) {
                $that.reportProficientCarFeeInfo.configId = '';
                vc.emit('reportProficientCarFee', 'notify', {});
                var param = {
                    params: {
                        page: 1,
                        row: 50,
                ...
                vc.http.get('roomCreateFeeAdd', 'list', param,
                    function (json, res) {
                        ...
                        vc.component.reportProficientCarFeeInfo.feeConfigs = _feeConfigManageInfo.feeConfigs;
                    },
