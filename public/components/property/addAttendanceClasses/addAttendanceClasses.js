(function (vc) {
    vc.extends({
        ...
        _initEvent: function () {
            vc.on('addAttendanceClasses', 'openAddAttendanceClassesModal', function (_param) {
                $that.addAttendanceClassesInfo.classesObjId = _param.classesObjId;
                $that.addAttendanceClassesInfo.classesObjName = _param.classesObjName;
