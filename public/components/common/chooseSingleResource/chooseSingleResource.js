    ...
    vc.extends({
        ...
        _initEvent: function () {
            vc.on('chooseSingleResource', 'openChooseSingleResourceModel', function (_param) {
                ...
                if (_param.sign != null && _param.sign != '' && _param.sign != undefined) {
                    vc.component.chooseSingleResourceInfo.sign = _param.sign;
                }
                if (_param.repairId != null && _param.repairId != '' && _param.repairId != undefined) {
                    vc.component.chooseSingleResourceInfo.repairId = _param.repairId;
                }
            ...
            _choseGoods: function () {
                ...
                var param = {
                    params: {
                        page: 1,
                        row: 100,
                        repairId: vc.component.chooseSingleResourceInfo.repairId,
                        rstId: vc.component.chooseSingleResourceInfo.rstId,
                        resId: vc.component.chooseSingleResourceInfo.resId,
                        communityId: vc.getCurrentCommunity().communityId,
                        chooseType: "repair",
                        flag: 1,
                        sign:  vc.component.chooseSingleResourceInfo.sign,
                        giveType: 1
                    }
                };
                //发送get请求
