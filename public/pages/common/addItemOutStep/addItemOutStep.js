        ...
        methods: {
            ...
            _nextStep: function () {
                ...
                for (var i = 0; i < _resourceStores.length; i++) {
                    ...
                    if (_resourceStores[i].quantity > parseInt(_resourceStores[i].stock)) {
                        vc.toast(_resourceStores[i].resName + ",库存不足");
                        return;
                    }
                }
                if (vc.component.addItemOutStepInfo.index != null && vc.component.addItemOutStepInfo.index != ''
                    && vc.component.addItemOutStepInfo.index != undefined && vc.component.addItemOutStepInfo.index == 1) {
                    if (vc.component.addItemOutStepInfo.infos[vc.component.addItemOutStepInfo.index].description == null ||
                        vc.component.addItemOutStepInfo.infos[vc.component.addItemOutStepInfo.index].description == '' ||
                        vc.component.addItemOutStepInfo.infos[vc.component.addItemOutStepInfo.index].description == undefined) {
                        vc.toast("请填写申请说明");
                        return;
                    }
                }
