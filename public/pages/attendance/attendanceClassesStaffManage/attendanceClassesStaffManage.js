...
(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
                ...
                vc.http.apiGet('/attendanceClasses.listAttendanceClassesStaff',
                    ...
                    function (json, res) {
                        ...
                        vc.emit('pagination', 'init', {
                            ...
                            dataCount: vc.component.attendanceClassesStaffManageInfo.total,
                            currentPage: _page
                        });
                    },
            ...
            //重置
            _resetAttendanceClassesStaffMethod: function () {
                vc.component.attendanceClassesStaffManageInfo.conditions.staffNameLike = "";
                vc.component._listAttendanceClassesStaffs(DEFAULT_PAGE, DEFAULT_ROWS);
            },
