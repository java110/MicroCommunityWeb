    ...
    vc.extends({
        ...
        methods:{
            _listClues:function(_page, _rows){
               ...
               //发送get请求
               vc.http.apiGet('/clue/queryMyClue',
                             param,
                             function(json,res){
            ...
            _openViewClueAttrModel:function(_clue){
                vc.jumpToPage("/admin.html#/pages/admin/viewClueInfo?clueId="+_clue.clueId);
            },
            ...
            _openEditClueAttrModel: function (_clue) {
                vc.jumpToPage('/admin.html#/pages/admin/clueAttrManage?clueId=' + _clue.clueId);
            },
