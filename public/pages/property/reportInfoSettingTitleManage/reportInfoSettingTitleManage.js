...
(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
            ...
            //重置
            _resetReportInfoSettingTitleMethod: function () {
                vc.component.reportInfoSettingTitleManageInfo.conditions.titleType = "";
                vc.component.reportInfoSettingTitleManageInfo.conditions.title = "";
                vc.component.reportInfoSettingTitleManageInfo.conditions.titleId = "";
                vc.component._listReportInfoSettingTitles(DEFAULT_PAGE, DEFAULT_ROWS);
            },
            _goBack: function () {
                vc.goBack();
