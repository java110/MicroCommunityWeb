    ...
    vc.extends({
        ...
        methods: {
            ...
            _openForceFinishRepairModel: function (_repair) {
                vc.jumpToPage('/#/pages/property/constrainFinishRepair?repairType=' + _repair.repairType + '&repairId=' + _repair.repairId + '&repairObjType='
                    + _repair.repairObjType + '&publicArea=' + _repair.publicArea + '&repairChannel=' + _repair.repairChannel);
            },
