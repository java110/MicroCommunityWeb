    ...
    vc.extends({
        ...
        methods: {
            ...
            _resetQuestionAnswerMethod: function () {
                vc.component.myQuestionAnswerManageInfo.conditions.qaType = "";
                vc.component.myQuestionAnswerManageInfo.conditions.qaName = "";
                vc.component.myQuestionAnswerManageInfo.conditions.qaId = "";
                vc.component._listQuestionAnswers(DEFAULT_PAGE, DEFAULT_ROWS);
            },
