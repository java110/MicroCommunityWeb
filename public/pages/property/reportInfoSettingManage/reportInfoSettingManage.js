    ...
    vc.extends({
        ...
        _initMethod: function () {
            ...
            vc.getDict('report_info_setting', "report_type", function (_data) {
                vc.component.reportInfoSettingManageInfo.reportTypes = _data;
            });
        ...
        methods: {
            _listReportInfoSettings: function (_page, _rows) {
                ...
                param.params.settingId = param.params.settingId.trim();
            ...
            //重置
            _resetReportInfoSettingMethod: function () {
                vc.component.reportInfoSettingManageInfo.conditions.name = "";
                vc.component.reportInfoSettingManageInfo.conditions.settingId = "";
                vc.component.reportInfoSettingManageInfo.conditions.reportType = "";
                vc.component._listReportInfoSettings(DEFAULT_PAGE, DEFAULT_ROWS);
            },
