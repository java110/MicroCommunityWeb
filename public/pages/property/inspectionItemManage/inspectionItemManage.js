    ...
    vc.extends({
        ...
        methods: {
                ...
                vc.http.apiGet('/inspectionItem.listInspectionItem',
                    ...
                    function (json, res) {
                        ...
                        vc.emit('pagination', 'init', {
                            ...
                            dataCount: vc.component.inspectionItemManageInfo.total,
                            currentPage: _page
                        });
                    },
            ...
            _resetInspectionItemMethod: function () {
                vc.component.inspectionItemManageInfo.conditions.itemId = "";
                vc.component.inspectionItemManageInfo.conditions.itemName = "";
                vc.component._listInspectionItems(DEFAULT_PAGE, DEFAULT_ROWS);
            },
