...
(function (vc) {
    ...
    vc.extends({
        ...
        methods: {
            ...
            //重置
            _resetOweFeeCallableMethod: function () {
                vc.component.oweFeeCallableInfo.conditions.ownerName = "";
                vc.component.oweFeeCallableInfo.conditions.feeName = "";
                vc.component.oweFeeCallableInfo.conditions.callableWay = "";
                vc.component.oweFeeCallableInfo.conditions.staffName = "";
                vc.component.oweFeeCallableInfo.conditions.state = "";
                $that._listOweFeeCallables(DEFAULT_PAGE, DEFAULT_ROWS);
            },
